...
const Cart = () => {
    ...
    return(
        <> 
<button type="button" className="btn btn-info" data-bs-toggle="modal" data-bs-targer="#CartModal">
...
<div className="modal fade" id="CartModal" tabIndex="-1" aria-labelledby="CartModalLabel" aria-hidden="true">
    <div className="modal-dialog">
        <div className="modal-header">
            <h5 className="modal-title" id="CardModalLabel">Meu Carrinho</h5>
    ...
    <table className="table table-hover">
        ...
        <tbody>
            {cart.Cart.map(item =>{
                return(
                <tr key={item.id}>
                    <th><buton onClick={()=>dispatch(cartActions.DeleteItem(cart, item))} className="badge bg-dange"><i className="fas fa-window-close"></i></buton></th>
